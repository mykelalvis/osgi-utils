...
public class Activator implements BundleActivator{
	...
	private PostgresqlDataSourceFactoryImpl factoryImpl = new PostgresqlDataSourceFactoryImpl();
	...
	public void start(BundleContext context) throws Exception {
		...
		props.put(DataSourceFactory.OSGI_JDBC_DRIVER_NAME, "Postgresql driver");
